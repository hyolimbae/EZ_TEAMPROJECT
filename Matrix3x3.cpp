...
{
	Vector3 result;
	result.x = left.x  * right.m[0][0] + left.y  * right.m[1][0] + left.z * right.m[2][0];
	result.y = left.x  * right.m[0][1] + left.y  * right.m[1][1] + left.z * right.m[2][1];
	result.z = left.x  * right.m[0][2] + left.y  * right.m[1][2] + left.z * right.m[2][2];
